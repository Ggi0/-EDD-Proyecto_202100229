...
class listaSimpleEnlazada{
    ...
    public:
        ...
        // ----- DESTRUCTOR ------
        listaSimpleEnlazada(const listaSimpleEnlazada& other); // Constructor de copia
        listaSimpleEnlazada& operator=(const listaSimpleEnlazada& other); // Operador de asignación
        ~listaSimpleEnlazada();
        ...
        int findIndex(int valor) const; // encuentra el indice de un valor concreto
        void graph();
        int size();
