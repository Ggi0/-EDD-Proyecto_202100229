...
Usuarios::Usuarios(const Usuarios& other) {
    ID = other.ID;
    ...
    listaSolicitudes = other.listaSolicitudes;
    pilaSolicitudes = other.pilaSolicitudes;
    lista_amigos = other.lista_amigos;
    bst_feedPublicaciones = other.bst_feedPublicaciones;
}
